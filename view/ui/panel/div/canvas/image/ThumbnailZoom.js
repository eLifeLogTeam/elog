 ...
 *
 *     @example preview
 *     Ext.create('Elog.view.ui.panel.div.canvas.image.ThumbnailZoom', {
 *     	fullscreen:true
 *     });
 *
 */
Ext.define('Elog.view.ui.panel.div.canvas.image.ThumbnailZoom', {
    ...
    */
	...
	onUpdateImageList : function(oImage, iImageId) {
	    ...
	    if (oImage.src.match(/width\%22:[0-9]+,/gi)) {
			...
			this.getZoomImage().src =  oImage.src.replace(/width%22:%22[0-9]+%22,/gi, "width%22:null,");
		}
		else {
