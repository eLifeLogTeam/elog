...
Ext.define('Elog.api.media.SensorKeyValueManager', {
    ...
    config: {
        ...
        commands : {
        	...
        	getSensorStatistics: 'Sensor.base.GetSensorStatistics',
        }
    },
    ...
    /**
     * Get Sensor statistics data
     * 
     * @param {Object} cfg
     * @param {Object} sensors sensor names list
     * @param {String} cfg.sensors Combination of sensor list. 
     */
    getSensorStatistics: function (cfg) {
    	var oSensorKeyValueManager = this;
    	this.getServerQuery({
    		command: this.getCommands().getSensorStatistics,
    		params:cfg,
    		onSuccess: function(oResult) {
    			if (typeof oResult.root == "undefined") {
    				oSensorKeyValueManager.logError('Server connection failed. Check the internet connection');
